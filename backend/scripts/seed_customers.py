...
CUSTOMER_PROFILE: dict[str, dict] = {
    ...
    # ── 포스코인터내셔널 — 단일 entity (product_group=["후판","선재"]) ──
    # PRD 결함 3 해결: customer_profile 분리 폐기. sales_service 가 출하실적의
    # variant_code → product_variants.product 매핑으로 본인 제품(박지은=선재,
    # 박현웅=후판) 의 출하만 자동 분기 집계.
    "포스코인터내셔널": {
...
ASSIGNMENTS: dict[str, list[str]] = {
    "emp_2026003": [  # 박지은 (선재 5) — 포스코인터내셔널은 단일 키로 공유
        "포스코인터내셔널",
        "고려제강",
        "Nissan Motor Co., Ltd",
        "New Best Wire Industrial Co., Ltd",
    ...
    "emp_2026004": [  # 박현웅 (후판 5) — 포스코인터내셔널 공유
        "현대중공업",
        "삼성중공업",
        "한화오션",
        "포스코건설",
